  ...
  <div class="body">
    <div class="inbody">
      <div class="block1">
        ...
        <p>Dear admin, please test your app here..</p>
    <br>
...
<span class="visually-hidden">Loading...</span>
  ...
  <div class="block2">
    ...
    <br>
    <p>Your transcribed speech is given below..</p>
    <br><br>
      ...
      if (this.mediaRecorder) {
        ...
        this.mediaRecorder.onstop = async () => {
          ...
          try {
            ...
            const response = await axios.post('http://127.0.0.1:5000/test-transcribe', formData, {
              headers: {
...
.inbody{
  ...
  width: 100%;
  min-height: 80vh; /* Adjust the height */
  overflow: auto;
  display:flex;
  column-gap: 5%;
}
